...
module.exports = function () {
	...
	//
	// Returns an html-string of the categories on the project.
	// By default, categories are separated by commas.
	// input. categories:['tech', 'js']
	// output. 'Filed Undder <a href="works/tech">tech</a>, <a href="works/js">js</a>'
	...
	// Used to generate the link for the admin edit project button
	...
	_helpers.projectUrl = function (projectSlug, options) {
		return ('/works/project/' + projectSlug);
	};

	// might be a ghost helper
	// used for pagination urls on works
	_helpers.pageUrl = function (pageNumber, options) {
		return '/works?page=' + pageNumber;
	};

	// create the category url for a works-category page
	_helpers.categoryUrl = function (categorySlug, options) {
		return ('/works/' + categorySlug);
	};
	...
	/*
	* expecting the data.projects context or an object literal that has `previous` and `next` properties
	...
	* */
	_helpers.ifHasPagination = function (projectContext, options) {
		...
		if (_.isUndefined(projectContext)) {
			return options.inverse(this);
		}
		if (projectContext.next || projectContext.previous) {
			return options.fn(this);
		}
		return options.inverse(this);
	};
